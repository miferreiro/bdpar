...
<div style="text-aling:justify">
For this preprocessing we will use both the default preprocessing flow (SerialPipes) and the default way to create the Instances (ExtractorFactory). 
...
pipeline_execute(path = system.file(package = "bdpar", "testFiles"))
```
