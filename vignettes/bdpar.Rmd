  ...
  public = list(
    ...
    pipe = function(instance) {
      ...
      if (!instance$checkCompatibility("RemovesWhiteSpaces", 
        ...
        stop("[RemovesWhiteSpaces][pipe][Error] Bad compatibility between Pipes")
      }
...
On the other hand, it facilitates the workflow between pipes because it automatically invokes the *pipe* function of the objects that pass through it.
